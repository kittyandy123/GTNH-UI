...
export type PlannerNodeKind =
  'recipe' | 'base-supply' | 'manual-import' | 'stockpile' | 'void' | 'passive-source' | 'note'

export type PlannerNodeStatus = 'planned' | 'built' | 'measured' | 'stale' | 'disabled'

export type PlannerEdgeStatus = 'satisfied' | 'short' | 'excess' | 'voided' | 'imported' | 'looped'

export type PlannerTargetMode = 'continuous' | 'batch' | 'on-demand' | 'passive'
...
export function getDefaultRecipeTargetRatePerSecond(
