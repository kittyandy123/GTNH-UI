...
describe('computePlannerDraftSummary', () => {
  ...
  it('solves automatic machine count from a wanted output rate', () => {
    ...
    draft = setPlannerDraftStackConstraintRate(draft, TARGET_KEY, 'output-wanted', 6)
  ...
  it('uses the lowest provided-input capacity as the limiting rate', () => {
    ...
    draft = setPlannerDraftConstraintSolveMode(draft, 'from-inputs')

    draft = setPlannerDraftStackConstraintRate(draft, INPUT_A_KEY, 'input-provided', 8)

    draft = setPlannerDraftStackConstraintRate(draft, INPUT_B_KEY, 'input-provided', 3)
  ...
  it('does not label abundant inputs as limiting when machines are the bottleneck', () => {
    ...
    draft = setPlannerDraftStackConstraintRate(draft, INPUT_A_KEY, 'input-provided', 100)

    draft = setPlannerDraftStackConstraintRate(draft, INPUT_B_KEY, 'input-provided', 100)
