...
export function getPlannerTargetOutput(
...
export function getBaseOutputRatePerSecond(
  recipe: NormalizedExportRecipe,
  draft: PlannerDraft,
): number | undefined {
...
export function getRequiredMachineCount(
  recipe: NormalizedExportRecipe,
  draft: PlannerDraft,
): number | undefined {
...
export function getRoundedRequiredMachineCount(
  recipe: NormalizedExportRecipe,
  draft: PlannerDraft,
): number | undefined {
...
export function getRecipeOperationsPerSecond(
  recipe: NormalizedExportRecipe,
  draft: PlannerDraft,
): number | undefined {
  const targetRate = getPlannerDraftTargetRatePerSecond(draft)
...
export function getPlannedInputRates(
  recipe: NormalizedExportRecipe,
  draft: PlannerDraft,
): PlannerStackRate[] {
...
export function getPlannedOutputRates(
  recipe: NormalizedExportRecipe,
  draft: PlannerDraft,
): PlannerStackRate[] {
  const operationsPerSecond = getRecipeOperationsPerSecond(recipe, draft)
...
export function getPerMachineStackRate(
  stack: ExportStack,
  recipe: NormalizedExportRecipe,
): number | undefined {
...
export function getPlannerPowerEstimate(
  recipe: NormalizedExportRecipe,
  draft: PlannerDraft,
