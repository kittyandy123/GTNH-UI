...
import { computePlannerDraftSummary, type PlannerStackRate } from '../planner/calc/planSummary'
...
export function PlannerRateBreakdown({
  recipe,
  draft,
  onFindProducers,
  onFindUses,
}: PlannerRateBreakdownProps) {
  ...
  return (
    <section className="planner-rate-breakdown" aria-label="Planner direct rates">
      <div className="panel-heading">
        ...
        <p>Scaled rates for the selected recipe only. Dependency solving comes later.</p>
